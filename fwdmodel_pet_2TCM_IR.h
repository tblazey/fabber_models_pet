...
class PET_2TCM_IR_FwdModel : public PETFwdModel
{
public:
    static FwdModel *NewInstance();

    PET_2TCM_IR_FwdModel()
    {
    }
...
private:
    ...
    static FactoryRegistration<FwdModelFactory, PET_2TCM_IR_FwdModel> registration;
};
